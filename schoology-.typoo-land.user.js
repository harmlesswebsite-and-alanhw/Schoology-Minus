// ==UserScript==
// @name         Schoology Minus (Typoo Land)
// @description  Mod the interface, but with a lot more typos than ordinary Schoology Minus
// @version      8.8.8.5
// @author       weeklyd3
...
/* 
    ...
    OR ESLE AL FO ORU TYPOOS WILLL BEE GNOE! OHH NOES!
*/
...
function letterGrade(grade) {
    if (grade > 100) return "HEEY! Yuo Chaeted!";
    if (90 <= grade && grade <= 100) return 'A - AVREAGE and AFWUL!';
    if (80 <= grade && grade < 90) return 'B - U GEET B? STOOOOOBDI';
    if (70 <= grade && grade < 80) return 'C - REOOD IT';
    if (60 <= grade && grade < 70) return 'D - YUU SUCK';
    if (0 < grade && grade < 60) return 'F - YOU AE A FALIUE';
    if (grade === 0) return 'U GTE 0 HEEHHEHEHEHE';
    return 'The techer gave u neagtive scor. Get Nubem mirablemed'
}
function getGradeColor(letterGrade) {
    switch (letterGrade.charAt(0)) {
        case 'HEEY! Yuo Chaeted!'.charAt(0):
            return green;
            break;
        case 'A - AVREAGE and AFWUL!'.charAt(0):
            return '#69b34c'; // Original: #69b34c
            break;
        case 'B - U GEET B? STOOOOOBDI'.charAt(0):
            return '#acb334'; // Original: #acb334
            break;
        case 'C - REOOD IT'.charAt(0):
            return '#fab733'; // Original: #fab733
            break;
        case 'D - YUU SUCK'.charAt(0):
            return '#ff8e15'; // Original: #ff8e15
            break;
        case 'F - YOU AE A FALIUE'.charAt(0):
            return '#ff4e11'; // Original: #ff4e11
            break;
        case 'U GTE 0 HEEHHEHEHEHE'.charAt(0):
            return 'red'; // Original: red
            break;
        case 'The techer gave u neagtive scor. Get Nubem mirablemed'.charAt(0):
...
<div style="color: black; padding: 7px; position: fixed; top: 50%; left: 50%; overflow: scroll; width: 75%; height: 75%; transform: translate(-50%, -50%); background-color: white;"><h2>Schoooolgy Ninus Setitngs</h2>
<p>You can modify the interfeces here.</p>
