// ==UserScript==
// @name         Schoology Minus, but Blank
// @description  Mod the interface, but without any messages
// @version      8.8.8.5
// @author       weeklyd3
...
function letterGrade(grade) {
    if (grade > 100) return "";
    if (90 <= grade && grade <= 100) return '';
    if (80 <= grade && grade < 90) return '';
    if (70 <= grade && grade < 80) return '';
    if (60 <= grade && grade < 70) return '';
    if (0 < grade && grade < 60) return '';
    if (grade === 0) return '';
    return ''
}
